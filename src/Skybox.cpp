...
void Skybox::DrawSkyBox(glm::mat4 viewMatrix, glm::mat4 projectionMatrix)
{
    ...
    glUniformMatrix4fv(glGetUniformLocation(skyboxShaderObj.ID, "view"), 1, GL_FALSE, glm::value_ptr(viewMatrix));
    glUniformMatrix4fv(glGetUniformLocation(skyboxShaderObj.ID, "projection"), 1, GL_FALSE, glm::value_ptr(projectionMatrix));
